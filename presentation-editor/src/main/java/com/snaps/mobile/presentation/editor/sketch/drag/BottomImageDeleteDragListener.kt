...
class BottomImageDeleteDragListener(
    ...
    override fun onDrag(v: View, event: DragEvent): Boolean {
        ...
        return when (event.action) {
            DragEvent.ACTION_DRAG_STARTED -> {
                event.clipDescription.hasMimeType(ClipDescription.MIMETYPE_TEXT_PLAIN) && dropItem.isAvailableDelete()
            }
            ...
            DragEvent.ACTION_DRAG_ENTERED -> {
                ...
                dropItem.onEnterBottomDeleteZone()
            ...
            DragEvent.ACTION_DRAG_EXITED -> {
                dropItem.onExitBottomDeleteZone()
    ...
    interface DropItem : SketchDraggable {
        ...
        fun onEnterBottomDeleteZone()
        fun onExitBottomDeleteZone()
        fun isAvailableDelete(): Boolean
