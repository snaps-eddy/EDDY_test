...
/**
 * Created by ysjeong on 2017. 12. 6..
 */

public class IgnoreExifStream extends FilterInputStream {
    ...
    public IgnoreExifStream(InputStream in, int orientation) {
        super(in);
