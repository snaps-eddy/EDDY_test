...
public class Xml_PushCrmUser {
	public List<PushCrmUser> pushCrmUserList = new ArrayList<Xml_PushCrmUser.PushCrmUser>();

	public static class PushCrmUser {
		...
		public PushCrmUser(String f_BRDCST_CODE, String f_IMG_EXIST, String f_CLOSE_YORN, String f_RCV_TYPE, String f_IMG_PATH, String f_TARGET_PATH, String f_STATUS) {
