...
public class Xml_PushAllUser {
	public List<PushAllUser> pushAllUserList = new ArrayList<Xml_PushAllUser.PushAllUser>();
	
	public static class PushAllUser {
		...
		public String F_STATUS; //결과 
		
		public PushAllUser(String f_BRDCST_CODE, String f_IMG_EXIST ,String f_CLOSE_YORN, String f_RCV_TYPE, String f_IMG_PATH, String f_TARGET_PATH, String f_STATUS) {
