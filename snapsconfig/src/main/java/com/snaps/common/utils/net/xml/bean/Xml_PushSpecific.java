...
public class Xml_PushSpecific {
	public List<PushSpecific> PushSpecificList = new ArrayList<Xml_PushSpecific.PushSpecific>();
	
	public static class PushSpecific {
		...
		public PushSpecific(String f_BRDCST_CODE, String f_IMG_EXIST, String f_CLOSE_YORN, String f_RCV_TYPE, String f_IMG_PATH, String f_TARGET_PATH, String f_STATUS) {
