...
public class BetweenImageData implements Parcelable {
	private static final String TAG = BetweenImageData.class.getSimpleName();
	public String ID = "";
	...
	public BetweenImageData(Parcel in) {
		readFromParcel(in);
	}
	...
	public static final Parcelable.Creator CREATOR = new Parcelable.Creator() {
		...
		public BetweenImageData[] newArray(int size) {
			return new BetweenImageData[size];
		}
	};
}
