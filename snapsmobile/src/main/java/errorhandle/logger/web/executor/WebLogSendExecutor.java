...
public class WebLogSendExecutor extends ThreadPoolExecutor {
    ...
    public void start(WebLogRequestInfo requestInfo) {
        this.execute(WebLogSender.createWebLogSenderWithRequestInfo(requestInfo));
    }
}
