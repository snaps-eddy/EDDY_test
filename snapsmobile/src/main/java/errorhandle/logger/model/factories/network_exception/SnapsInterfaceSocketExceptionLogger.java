 ...
 */
public class SnapsInterfaceSocketExceptionLogger extends SnapsInterfaceLogger {
    private static final long serialVersionUID = 8191934368323154237L;
    private final int MAX_LENGTH_LOG_STRING = 10240;

    public SnapsInterfaceSocketExceptionLogger(SnapsLoggerAttribute attribute) {
        super(attribute);
    }
