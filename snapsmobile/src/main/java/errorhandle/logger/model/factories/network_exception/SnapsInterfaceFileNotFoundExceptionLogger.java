 ...
 */
public class SnapsInterfaceFileNotFoundExceptionLogger extends SnapsInterfaceLogger {
    private static final long serialVersionUID = 8191934368323154237L;
    private final int MAX_LENGTH_LOG_STRING = 10240;

    public SnapsInterfaceFileNotFoundExceptionLogger(SnapsLoggerAttribute attribute) {
        super(attribute);
    }
