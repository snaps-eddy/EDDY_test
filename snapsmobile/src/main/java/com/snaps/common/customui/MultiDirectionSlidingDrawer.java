...
public class MultiDirectionSlidingDrawer extends ViewGroup {
	private static final String TAG = MultiDirectionSlidingDrawer.class.getSimpleName();
	...
	public void setData(int direction, boolean allowSingleTap, int content, int handle) {
		mVertical = ( direction == ORIENTATION_BTT || direction == ORIENTATION_TTB );
		mAllowSingleTap = allowSingleTap;
		mHandleId = handle;
		mContentId = content;
	}
