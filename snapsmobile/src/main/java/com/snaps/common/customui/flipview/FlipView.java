package com.snaps.common.customui.flipview;
...
public class FlipView extends FrameLayout {
	...
	public void setFlipEnable(boolean enable) {
		mIsFlippingEnabled = enable;
	}
	...
	private int getNewPositionOfCurrentPage() {
		Dlog.d("getNewPositionOfCurrentPage() mCurrentPage:" + mCurrentPage + ", mCurrentPageId:" + mCurrentPageId);
	...
	public void smoothFlipTo(int page, int duration) {
		if (page < 0 || page > mPageCount - 1) {
			throw new IllegalArgumentException("That page does not exist");
		}
