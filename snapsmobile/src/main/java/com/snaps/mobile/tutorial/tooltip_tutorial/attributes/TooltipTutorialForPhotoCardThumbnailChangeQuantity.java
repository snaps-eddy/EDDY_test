...
public class TooltipTutorialForPhotoCardThumbnailChangeQuantity extends TooltipTutorialBase {
    ...
    public TooltipTutorialForPhotoCardThumbnailChangeQuantity(Activity activity, SnapsTutorialAttribute tutorialAttribute) {
    ...
    public static TooltipTutorialCreator createInstanceWithTutorialAttribute(Activity activity, SnapsTutorialAttribute attribute) {
        return new TooltipTutorialForPhotoCardThumbnailChangeQuantity(activity, attribute);
    }
