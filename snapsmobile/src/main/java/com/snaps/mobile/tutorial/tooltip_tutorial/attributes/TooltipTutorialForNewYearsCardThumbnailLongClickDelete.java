...
public class TooltipTutorialForNewYearsCardThumbnailLongClickDelete extends TooltipTutorialBase {

    public TooltipTutorialForNewYearsCardThumbnailLongClickDelete(Activity activity, SnapsTutorialAttribute tutorialAttribute) {
    ...
    public static TooltipTutorialCreator createInstanceWithTutorialAttribute(Activity activity, SnapsTutorialAttribute attribute) {
        return new TooltipTutorialForNewYearsCardThumbnailLongClickDelete(activity, attribute);
    }
