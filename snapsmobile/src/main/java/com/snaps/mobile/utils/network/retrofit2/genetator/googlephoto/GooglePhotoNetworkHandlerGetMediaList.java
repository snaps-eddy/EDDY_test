...
public class GooglePhotoNetworkHandlerGetMediaList extends SnapsNetworkGenerateBase {

    @Override
    protected Flowable<?> generateRetrofitAPIService(@NonNull SnapsRetrofitRequestBuilder requestBuilder) throws Exception {
        return createAPI(IGooglePhotoAPI.class).requestAPIMediaList("application/json", "application/json", GooglePhotoUtil.getBearerToken(), 20, null);
    }
