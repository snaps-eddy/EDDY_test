...
public class SnapsSelectProductJunctionForReflectiveSlogan implements ISnapsProductLauncher {
    @Override
    public boolean startMakeProduct(Activity activity, SnapsProductAttribute attribute) {
        ...
        bundle.putInt(SnapsProductEditConstants.EXTRA_NAME_PRODUCT_KIND, SnapsProductEditConstants.eSnapsProductKind.REFLECTIVE_SLOGAN.ordinal());
