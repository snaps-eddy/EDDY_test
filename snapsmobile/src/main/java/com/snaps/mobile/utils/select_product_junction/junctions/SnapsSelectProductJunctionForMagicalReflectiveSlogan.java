...
public class SnapsSelectProductJunctionForMagicalReflectiveSlogan implements ISnapsProductLauncher {
    @Override
    public boolean startMakeProduct(Activity activity, SnapsProductAttribute attribute) {
        ...
        bundle.putInt(SnapsProductEditConstants.EXTRA_NAME_PRODUCT_KIND, SnapsProductEditConstants.eSnapsProductKind.MAGICAL_REFLECTIVE_SLOGAN.ordinal());
