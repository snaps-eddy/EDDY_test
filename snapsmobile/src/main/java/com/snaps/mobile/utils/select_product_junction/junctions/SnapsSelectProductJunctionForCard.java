...
public class SnapsSelectProductJunctionForCard implements ISnapsProductLauncher {
    @Override
    public boolean startMakeProduct(Activity activity, SnapsProductAttribute attribute) {
        ...
        Config.setCARD_QUANTITY(urlData.get(Const_EKEY.WEB_CARD_CNT_KEY));

//        if (Config.getCARD_QUANTITY() == null || Config.getCARD_QUANTITY().equals("0")) {
//            MessageUtil.toast(activity, activity.getString(R.string.quantity_is_not_enought_msg));//"수량을 1장이상으로 선택해 주세요!!");
//            return true;
//        }
        ...
        ImageSelectIntentData intentDatas = new ImageSelectIntentData.Builder()
                .setHomeSelectProduct(Config.SELECT_CARD)
        ...
        bundle.putInt(SnapsProductEditConstants.EXTRA_NAME_PRODUCT_KIND, SnapsProductEditConstants.eSnapsProductKind.CARD.ordinal());
