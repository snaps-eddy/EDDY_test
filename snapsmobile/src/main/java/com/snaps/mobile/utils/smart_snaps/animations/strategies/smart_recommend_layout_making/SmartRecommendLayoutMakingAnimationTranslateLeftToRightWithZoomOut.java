...
public class SmartRecommendLayoutMakingAnimationTranslateLeftToRightWithZoomOut extends SmartRecommendLayoutMakingAnimationBase {
    private static final String TAG = SmartRecommendLayoutMakingAnimationTranslateLeftToRightWithZoomOut.class.getSimpleName();

    public SmartRecommendLayoutMakingAnimationTranslateLeftToRightWithZoomOut(SmartRecommendLayoutMakingAnimationAttribute animationAttribute) {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    try {
                        ...
                        if (visibleImageView != null) {
                            ...
                            float scale = defaultScaleValue + (float) (0.025 * animatedValue);
