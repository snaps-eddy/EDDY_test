 ...
 */
public class SnapsPagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public SnapsPagerSlidingTabStrip(Context context) {
        this(context, null);
    }

    public SnapsPagerSlidingTabStrip(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SnapsPagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        a = context.obtainStyledAttributes(attrs, com.snaps.mobile.R.styleable.PagerSlidingTabStrip);

        indicatorColor = a.getColor(com.snaps.mobile.R.styleable.PagerSlidingTabStrip_pstsIndicatorColor, indicatorColor);
        underlineColor = a.getColor(com.snaps.mobile.R.styleable.PagerSlidingTabStrip_pstsUnderlineColor, underlineColor);
        dividerColor = a.getColor(com.snaps.mobile.R.styleable.PagerSlidingTabStrip_pstsDividerColor, dividerColor);
        indicatorHeight = a.getDimensionPixelSize(com.snaps.mobile.R.styleable.PagerSlidingTabStrip_pstsIndicatorHeight, indicatorHeight);
        underlineHeight = a.getDimensionPixelSize(com.snaps.mobile.R.styleable.PagerSlidingTabStrip_pstsUnderlineHeight, underlineHeight);
        dividerPaddingTopBottom = a.getDimensionPixelSize(com.snaps.mobile.R.styleable.PagerSlidingTabStrip_pstsDividerPaddingTopBottom, dividerPaddingTopBottom);
        tabPadding = a.getDimensionPixelSize(com.snaps.mobile.R.styleable.PagerSlidingTabStrip_pstsTabPaddingLeftRight, tabPadding);
        tabBackgroundResId = a.getResourceId(com.snaps.mobile.R.styleable.PagerSlidingTabStrip_pstsTabBackground, tabBackgroundResId);
        shouldExpand = a.getBoolean(com.snaps.mobile.R.styleable.PagerSlidingTabStrip_pstsShouldExpand, shouldExpand);
        scrollOffset = a.getDimensionPixelSize(com.snaps.mobile.R.styleable.PagerSlidingTabStrip_pstsScrollOffset, scrollOffset);
        textAllCaps = a.getBoolean(com.snaps.mobile.R.styleable.PagerSlidingTabStrip_pstsTextAllCaps, textAllCaps);
        selectedTabTextColor = a.getColor(com.snaps.mobile.R.styleable.PagerSlidingTabStrip_pstsTextSelectedColor, selectedTabTextColor);
        zoomMax = a.getFloat(com.snaps.mobile.R.styleable.PagerSlidingTabStrip_pstsScaleZoomMax, zoomMax);
        a.recycle();
