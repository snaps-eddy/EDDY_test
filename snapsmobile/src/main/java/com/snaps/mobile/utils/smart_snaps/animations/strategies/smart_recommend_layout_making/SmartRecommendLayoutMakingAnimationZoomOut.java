...
public class SmartRecommendLayoutMakingAnimationZoomOut extends SmartRecommendLayoutMakingAnimationBase {
    private static final String TAG = SmartRecommendLayoutMakingAnimationZoomOut.class.getSimpleName();

    public SmartRecommendLayoutMakingAnimationZoomOut(SmartRecommendLayoutMakingAnimationAttribute animationAttribute) {
    ...
    public SmartRecommendLayoutMakingAnimationFactory.eSmartRecommendLayoutMakingAnimationType getAnimationType() {
        return SmartRecommendLayoutMakingAnimationFactory.eSmartRecommendLayoutMakingAnimationType.ZOOM_OUT;
    }
