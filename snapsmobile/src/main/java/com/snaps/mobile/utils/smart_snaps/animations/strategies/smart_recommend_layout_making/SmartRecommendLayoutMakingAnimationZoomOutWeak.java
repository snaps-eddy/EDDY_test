...
public class SmartRecommendLayoutMakingAnimationZoomOutWeak extends SmartRecommendLayoutMakingAnimationBase {
    private static final String TAG = SmartRecommendLayoutMakingAnimationZoomOutWeak.class.getSimpleName();

    public SmartRecommendLayoutMakingAnimationZoomOutWeak(SmartRecommendLayoutMakingAnimationAttribute animationAttribute) {
    ...
    public SmartRecommendLayoutMakingAnimationFactory.eSmartRecommendLayoutMakingAnimationType getAnimationType() {
        return SmartRecommendLayoutMakingAnimationFactory.eSmartRecommendLayoutMakingAnimationType.ZOOM_OUT_WEAK;
    }
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    try {
                        ...
                        if (visibleImageView != null) {
                            float scale = 1.f + (float) (0.02 * animatedValue);
