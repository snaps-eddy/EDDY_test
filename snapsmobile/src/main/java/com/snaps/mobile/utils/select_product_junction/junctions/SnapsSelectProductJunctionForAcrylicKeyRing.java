...
public class SnapsSelectProductJunctionForAcrylicKeyRing implements ISnapsProductLauncher {
    ...
    public boolean startMakeProduct(Activity activity, SnapsProductAttribute attribute) {
        ...
        bundle.putInt(SnapsProductEditConstants.EXTRA_NAME_PRODUCT_KIND, SnapsProductEditConstants.eSnapsProductKind.ACRYLIC_KEYRING.ordinal());
