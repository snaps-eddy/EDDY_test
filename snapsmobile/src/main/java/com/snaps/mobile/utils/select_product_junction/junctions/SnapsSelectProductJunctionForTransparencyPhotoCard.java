...
public class SnapsSelectProductJunctionForTransparencyPhotoCard implements ISnapsProductLauncher {
    ...
    private boolean performMakeProduct(Activity activity, SnapsProductAttribute attribute) {
        ...
        ImageSelectIntentData intentDatas = new ImageSelectIntentData.Builder()
                .setHomeSelectProduct(Config.SELECT_TRANSPARENCY_PHOTO_CARD)
        ...
        bundle.putInt(SnapsProductEditConstants.EXTRA_NAME_PRODUCT_KIND, SnapsProductEditConstants.eSnapsProductKind.TRANSPARENCY_PHOTO_CARD.ordinal());
