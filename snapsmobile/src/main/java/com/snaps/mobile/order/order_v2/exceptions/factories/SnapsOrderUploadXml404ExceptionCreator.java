...
import com.snaps.mobile.order.order_v2.exceptions.SnapsOrderUploadXml404Exception;

/**
 * Created by ysjeong on 2017. 11. 22..
 */

public class SnapsOrderUploadXml404ExceptionCreator {
    public static SnapsOrderException createExceptionWithMessage(String detailMessage) {
        return new SnapsOrderUploadXml404Exception(detailMessage);
    }
}
