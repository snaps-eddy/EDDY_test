...
import com.snaps.mobile.order.order_v2.exceptions.SnapsOrderOrgImageUploadException;

/**
 * Created by ysjeong on 2017. 11. 22..
 */

public class SnapsOrderImageUploadExceptionCreator {
    public static SnapsOrderException createExceptionWithMessage(String detailMessage) {
        return new SnapsOrderOrgImageUploadException(detailMessage);
    }
}
