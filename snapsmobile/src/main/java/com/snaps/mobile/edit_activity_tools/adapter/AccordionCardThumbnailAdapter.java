 ...
 */
public class AccordionCardThumbnailAdapter extends BaseEditActivityThumbnailAdapter {
    private static final String TAG = AccordionCardThumbnailAdapter.class.getSimpleName();
    private Map<Integer, AccordionCardThumbnailHolder> m_mapThumbnailHolders = null;
        ...
        try {
            if (m_mapThumbnailHolders != null) {
                ...
                for (int key : m_mapThumbnailHolders.keySet()) {
                    AccordionCardThumbnailHolder holder = m_mapThumbnailHolders.get(key);
    ...
    public Map<Integer, AccordionCardThumbnailHolder> getThumbnailHolders() {
        return m_mapThumbnailHolders;
    }

    public AccordionCardThumbnailAdapter(Activity activity, SnapsProductEditInfo editInfo) {
    ...
    @Override
    public AccordionCardThumbnailHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        int layoutId = R.layout.bottomview_item_accoridon_card_dragable;

        View v = LayoutInflater.from(parent.getContext()).inflate(layoutId, parent, false);

        return new AccordionCardThumbnailHolder(v);
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        final AccordionCardThumbnailHolder holder = (AccordionCardThumbnailHolder) viewHolder;
        ...
        ViewGroup.LayoutParams imgParams = holder.canvasParentLy.getLayoutParams();
        if (imgParams.width != thumbnailRect.width() || imgParams.height != thumbnailRect.height()) {
            ...
            holder.canvasParentLy.setLayoutParams(imgParams);
            holder.itemOutLine.setLayoutParams(imgParams);
        }
    ...
    private void setTextSizeWithViewHolder(AccordionCardThumbnailHolder holder) {
...
//        mThumbnailRect = EditActivityThumbnailUtils.getAccordionCardRectOffsetThumbnailDimens(activity);
        mThumbnailRect = EditActivityThumbnailUtils.getRectAccordionCardThumbanilViewSizeOffsetPage(activity, isLandscapeMode, m_arrPageList.get(position));
        return mThumbnailRect;
    }
    ...
    private AccordionCardThumbnailHolder getThumbnailHolder(int position) {
    ...
    private void bottomViewItemClick(AccordionCardThumbnailHolder holder, boolean isClick) {
    ...
    public void onViewRecycled(RecyclerView.ViewHolder viewHolder) {
        AccordionCardThumbnailHolder holder = (AccordionCardThumbnailHolder) viewHolder;
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (actionState == ItemTouchHelper.ACTION_STATE_DRAG) {
            ...
            if (snapsProductEditorAPI != null) {
                AccordionCardThumbnailHolder holder = getThumbnailHolder(m_iMovedPosition);
                if (holder != null)
