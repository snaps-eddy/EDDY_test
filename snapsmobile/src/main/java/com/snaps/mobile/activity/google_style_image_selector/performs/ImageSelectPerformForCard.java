...
public class ImageSelectPerformForCard extends BaseImageSelectPerformer implements IImageSelectProductPerform {
    public ImageSelectPerformForCard(ImageSelectActivityV2 activity) {
        super(activity);
    }
...
//            Intent saveIntent = new Intent(imageSelectActivity, CardActivity.class);
            Intent saveIntent = new Intent(imageSelectActivity, SnapsEditActivity.class);
            saveIntent.putExtra(SnapsProductEditConstants.EXTRA_NAME_PRODUCT_KIND, SnapsProductEditConstants.eSnapsProductKind.CARD.ordinal());
