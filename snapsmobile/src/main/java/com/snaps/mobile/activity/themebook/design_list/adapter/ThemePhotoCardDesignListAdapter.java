...
public class ThemePhotoCardDesignListAdapter extends BaseThemeDesignListAdapter{
    private static final String TAG = ThemePhotoCardDesignListAdapter.class.getSimpleName();

    public ThemePhotoCardDesignListAdapter(Context context, DesignListAdapterAttribute adapterAttribute) {
    ...
    public void onBindViewHolder(DesignListHolder holder, int position) {
        try {
                ...
                LinearLayout.LayoutParams mFrameLayoutParams = new LinearLayout.LayoutParams((int) (getGridColumnWidth), (int) (getGridColumnWidth / 0.66f));
                RelativeLayout.LayoutParams mImageLayoutParams = new RelativeLayout.LayoutParams((int) (getGridColumnWidth), (int) (getGridColumnWidth /0.66f));
                RelativeLayout.LayoutParams mSelectLayoutParams = new RelativeLayout.LayoutParams((int) (getGridColumnWidth), (int) (getGridColumnWidth /0.66f));
