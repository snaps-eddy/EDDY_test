 ...
 */
public class ImageSelectUIProcessorStrategyForMultiPhotoChoose implements IImageSelectUIProcessorStrategy {
    /**
    ...
    public void initialize(ImageSelectUIProcessor activity) {
        ...
        activity.setImageSelectType(ImageSelectUIProcessorStrategyFactory.eIMAGE_SELECT_UI_TYPE.MULTI_CHOOSE);
    }
