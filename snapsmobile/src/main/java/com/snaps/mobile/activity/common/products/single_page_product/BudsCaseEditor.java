...
public class BudsCaseEditor extends SnapsSinglePageEditor {
    private static final String TAG = BudsCaseEditor.class.getSimpleName();

    public BudsCaseEditor(FragmentActivity fragmentActivity) {
