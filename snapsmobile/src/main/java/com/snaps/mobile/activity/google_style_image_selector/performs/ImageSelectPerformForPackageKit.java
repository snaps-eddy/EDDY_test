...
import static com.snaps.mobile.activity.google_style_image_selector.interfaces.ISnapsImageSelectConstants.REQCODE_EDIT;

/**
 * Created by ysjeong on 2016. 12. 2..
 */

public class ImageSelectPerformForPackageKit extends BaseImageSelectPerformer implements IImageSelectProductPerform {
    public ImageSelectPerformForPackageKit(ImageSelectActivityV2 activity) {
        super(activity);
    }
...
//            }
    ...
    public void moveNextActivity() {
        if(isSuccessSetSimpleDatas()) {
            ...
            saveIntent.putExtra(SnapsProductEditConstants.EXTRA_NAME_PRODUCT_KIND, SnapsProductEditConstants.eSnapsProductKind.PACKAGE_KIT.ordinal());
            saveIntent.putExtra("templete", TEMPLATE_PATH);
            imageSelectActivity.startActivityForResult(saveIntent, REQCODE_EDIT);
