 ...
 */
public class ImageSelectTrayTransparencyPhotoCardAdapter extends ImageSelectTrayBaseAdapter implements ISnapsDiaryRecyclerCustomAdapter {
    private static final String TAG = ImageSelectTrayTransparencyPhotoCardAdapter.class.getSimpleName();
    private ImageSelectTrayCellItem photoPrintDummyView = null;

    public ImageSelectTrayTransparencyPhotoCardAdapter(ImageSelectActivityV2 imageSelectActivityV2) {
