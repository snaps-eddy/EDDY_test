...
public class ImageSelectPerformForSingleChooseTypePhoneOnly extends BaseImageSelectPerformer implements IImageSelectProductPerform {

    public ImageSelectPerformForSingleChooseTypePhoneOnly(ImageSelectActivityV2 activity) {
        super(activity);
    }
