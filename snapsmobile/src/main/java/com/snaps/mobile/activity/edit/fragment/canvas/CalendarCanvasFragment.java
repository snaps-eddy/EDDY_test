...
public class CalendarCanvasFragment extends ThemeBookCanvasFragment {
    private static final String TAG = CalendarCanvasFragment.class.getSimpleName();
    float scale_X = 1.f;
    float scale_Y = 1.f;
    ...
    public void makeSnapsCanvas() {
        ...
        try {
            if (canvas == null) {
                canvas = new CalendarCanvas(getActivity().getApplicationContext());
            ...
            Dlog.e(TAG, "이미지 저장 실패 index:" + index, e);
