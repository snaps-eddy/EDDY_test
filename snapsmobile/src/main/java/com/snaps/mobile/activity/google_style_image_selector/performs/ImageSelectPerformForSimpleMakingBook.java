...
public class ImageSelectPerformForSimpleMakingBook extends BaseImageSelectPerformer implements IImageSelectProductPerform {

    public ImageSelectPerformForSimpleMakingBook(ImageSelectActivityV2 activity) {
        super(activity);
    }
...
//            }
    ...
    public void moveNextActivity() {
        if(isSuccessSetSimpleDatas()) {
            ...
            saveIntent.putExtra(SnapsProductEditConstants.EXTRA_NAME_PRODUCT_KIND, SnapsProductEditConstants.eSnapsProductKind.SIMPLE_MAKING_BOOK.ordinal());
