...
public class ImageSelectTraySmartSnapsSelectAdapter extends ImageSelectTrayBaseAdapter implements ISnapsDiaryRecyclerCustomAdapter {
    private static final String TAG = ImageSelectTraySmartSnapsSelectAdapter.class.getSimpleName();
    private ImageSelectTrayCellItem photoPrintDummyView = null;

    public ImageSelectTraySmartSnapsSelectAdapter(ImageSelectActivityV2 imageSelectActivityV2) {
        this(imageSelectActivityV2, imageSelectActivityV2);
    }

    protected ImageSelectTraySmartSnapsSelectAdapter(Context context, IImageSelectPublicMethods imageSelectPublicMethods) {
    ...
    protected void setSelectedImageInfo(String key) {
