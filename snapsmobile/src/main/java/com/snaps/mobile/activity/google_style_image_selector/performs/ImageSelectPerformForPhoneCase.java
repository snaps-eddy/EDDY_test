...
public class ImageSelectPerformForPhoneCase extends BaseImageSelectPerformer implements IImageSelectProductPerform {

    public ImageSelectPerformForPhoneCase(ImageSelectActivityV2 activity) {
        super(activity);
    }
...
//            }
        ...
        if (isNotAllSelected) {
            MessageUtil.alertnoTitle(imageSelectActivity, imageSelectActivity.getString(R.string.not_packaged_full_msg), clickedOk -> {
    ...
    public void moveNextActivity() {
        if(isSuccessSetSimpleDatas()) {
            ...
            saveIntent.putExtra(SnapsProductEditConstants.EXTRA_NAME_PRODUCT_KIND, SnapsProductEditConstants.eSnapsProductKind.PHONE_CASE.ordinal());
