...
public class ImageSelectPerformForCalendar extends BaseImageSelectPerformer implements IImageSelectProductPerform {
    public ImageSelectPerformForCalendar(ImageSelectActivityV2 activity) {
        super(activity);
    }
...
//            }
    ...
    public void moveNextActivity() {
        if (isSuccessSetSimpleDatas()) {
            ...
            int productEnumOrdinal = Config.isWoodBlockCalendar() ? SnapsProductEditConstants.eSnapsProductKind.WOODBLOCK_CALENDAR.ordinal() : SnapsProductEditConstants.eSnapsProductKind.CALENDAR.ordinal();
            saveIntent.putExtra(SnapsProductEditConstants.EXTRA_NAME_PRODUCT_KIND, productEnumOrdinal);
