...
public class SimplePhotoBookCanvas extends ThemeBookCanvas {
	private static final String TAG = SimplePhotoBookCanvas.class.getSimpleName();

	protected int pageCover_w = 0;
	protected int pageCover_h = 0;
	
	public SimplePhotoBookCanvas(Context context) {
		super(context);
	}

	public SimplePhotoBookCanvas(Context context, AttributeSet attr) {
		super(context, attr);
	}
